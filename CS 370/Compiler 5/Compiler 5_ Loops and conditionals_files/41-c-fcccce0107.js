...
for(;r<o.parts.length;r++)n.parts.push(j(o.parts[r],t))}else{var s=[]
for(r=0;r<o.parts.length;r++)s.push(j(o.parts[r],t))
...
s&&URL.revokeObjectURL(s)}},aVOL:function(e,t){(function(e){"use strict"
...
var r=i("5Ky4")
var s=i("/1jZ");(function(e){e.extend(mejs.MepDefaults,{startLanguage:"",tracksText:"",tracksAriaLive:false,hideCaptionsButtonWhenEmpty:true,toggleCaptionsButtonWhenOnlyOne:false,slidesSelector:""})
...
var r,s,l=this,d=l.options.tracksAriaLive?'role="log" aria-live="assertive" aria-atomic="false"':"",u=l.options.tracksText?l.options.tracksText:n.t("Captions/Subtitles")
...
"subtitles"!==s&&"captions"!==s||m++}var c="none"
...
Promise.all([i.e(4),i.e(582)]).then(i.bind(null,"z8T/")).then(e=>{let i=e.default
new i(t.options.mediaCommentId,t.media.src)})})
t.adjustLanguageBox()},addTrackButton:function(t,i,a){var o=this
""===i&&(i=mejs.language.codes[t]||t)
var s=""
o.options.can_add_captions&&(s='<a href="#" role="button" data-remove="li" data-confirm="'+Object(r["a"])(n.t("Are you sure you want to delete this track?"))+'" data-url="'+a+'" tabindex="-1" aria-label="'+Object(r["a"])(n.t("Delete track"))+'"><span aria-hidden="true">×<span></a>')
o.captionsButton.find("ul").append(e('<li><input type="radio" name="'+o.id+'_captions" id="'+o.id+"_captions_"+t+'" value="'+t+'" disabled="disabled" aria-selected="false" aria-label="'+i+' (loading)" tabindex="-1" /><label for="'+o.id+"_captions_"+t+'" aria-hidden="true">'+i+" (loading)</label>"+s+"</li>"))
o.adjustLanguageBox()
...
a.includes(n.tagName.toLowerCase())?o=o.concat(Array.from(n.children||[])):n.parentNode.removeChild(n)}var r=i.body.getElementsByTagName("*")
for(var s=0,l=r.length;s<l;s++){var d=r[s].attributes,u=Array.prototype.slice.call(d)
for(var m=0,c=u.length;m<c;m++)u[m].name.startsWith("on")||u[m].value.startsWith("javascript")?r[s].parentNode.removeChild(r[s]):"style"===u[m].name&&r[s].removeAttribute(u[m].name)}return i.body.innerHTML}
...
t.hasChapters=true
break}},drawChapters:function(t){var i,a,o=this,n=0,r=0
o.chapters.empty()
...
o.chapters.show()}})
mejs.language={codes:s["a"]}
mejs.TrackFormatParser={webvtt:{pattern_timecode:/^((?:[0-9]{1,2}:)?[0-9]{2}:[0-9]{2}([,.][0-9]{1,3})?) --\> ((?:[0-9]{1,2}:)?[0-9]{2}:[0-9]{2}([,.][0-9]{3})?)(.*)$/,parse:function(t){var i,a,o,n=0,r=mejs.TrackFormatParser.split2(t,/\r?\n/),s={text:[],times:[]}
...
s.text.push(a)
s.times.push({identifier:o,start:0===mejs.Utility.convertSMPTEtoSeconds(i[1])?.2:mejs.Utility.convertSMPTEtoSeconds(i[1]),stop:mejs.Utility.convertSMPTEtoSeconds(i[3]),settings:i[5]})}o=""}return s}},dfxp:{parse:function(t){t=e(t).filter("tt")
var i,a,o=0,n=t.children("div").eq(0),r=n.find("p"),s=t.find("#"+n.attr("style")),l={text:[],times:[]}
if(s.length){var d=s.removeAttr("id").get(0).attributes
if(d.length){i={}
for(o=0;o<d.length;o++)i[d[o].name.split(":")[1]]=d[o].value}}for(o=0;o<r.length;o++){var u
var m={start:null,stop:null,style:null}
r.eq(o).attr("begin")&&(m.start=mejs.Utility.convertSMPTEtoSeconds(r.eq(o).attr("begin")))
!m.start&&r.eq(o-1).attr("end")&&(m.start=mejs.Utility.convertSMPTEtoSeconds(r.eq(o-1).attr("end")))
r.eq(o).attr("end")&&(m.stop=mejs.Utility.convertSMPTEtoSeconds(r.eq(o).attr("end")))
!m.stop&&r.eq(o+1).attr("begin")&&(m.stop=mejs.Utility.convertSMPTEtoSeconds(r.eq(o+1).attr("begin")))
if(i){u=""
for(var c in i)u+=c+":"+i[c]+";"}u&&(m.style=u)
0===m.start&&(m.start=.2)
l.times.push(m)
...
u["a"].MepDefaults.success=function(e,t){i.e(597).then(i.bind(null,"ozaW")).then(t=>{let i=t.default
...
var f
m.a.mediaComment=function(e,t,i){var a=m()("<div/>")
m()("body").append(a.hide())
m.a.fn.mediaComment.apply(a,arguments)}
m.a.mediaComment.partnerData=function(e){var t={context_code:m.a.mediaComment.contextCode(),root_account_id:ENV.DOMAIN_ROOT_ACCOUNT_ID,context_source:ENV.CONTEXT_ACTION_SOURCE}
...
h(o)}
m.a.mediaComment.audio_delegate={readyHandler:function(){try{m()("#audio_upload")[0].setMediaType("audio")}catch(e){m.a.mediaComment.upload_delegate.setupErrorHandler()}},selectHandler:function(){m.a.mediaComment.upload_delegate.selectHandler("audio")},singleUploadCompleteHandler:function(e){m.a.mediaComment.upload_delegate.singleUploadCompleteHandler("audio",e)},allUploadsCompleteHandler:function(){m.a.mediaComment.upload_delegate.allUploadsCompleteHandler("audio")},entriesAddedHandler:function(e){m.a.mediaComment.upload_delegate.entriesAddedHandler("audio",e)},progressHandler:function(e){m.a.mediaComment.upload_delegate.progressHandler("audio",e[0],e[1],e[2])},uploadErrorHandler:function(){m.a.mediaComment.upload_delegate.uploadErrorHandler("audio")}}
m.a.mediaComment.video_delegate={readyWatcher:null,expectReady:function(){if(m.a.mediaComment.video_delegate.readyWatcher)return
m.a.mediaComment.video_delegate.readyWatcher=setTimeout(m.a.mediaComment.upload_delegate.setupErrorHandler,2e3)},readyHandler:function(){try{m()("#video_upload")[0].setMediaType("video")}catch(e){m.a.mediaComment.upload_delegate.setupErrorHandler()}clearTimeout(m.a.mediaComment.video_delegate.readyWatcher)
m.a.mediaComment.video_delegate.readyWatcher=true},selectHandler:function(){m.a.mediaComment.upload_delegate.selectHandler("video")},singleUploadCompleteHandler:function(e){m.a.mediaComment.upload_delegate.singleUploadCompleteHandler("video",e)},allUploadsCompleteHandler:function(){m.a.mediaComment.upload_delegate.allUploadsCompleteHandler("video")},entriesAddedHandler:function(e){m.a.mediaComment.upload_delegate.entriesAddedHandler("video",e)},progressHandler:function(e){m.a.mediaComment.upload_delegate.progressHandler("video",e[0],e[1],e[2])},uploadErrorHandler:function(){m.a.mediaComment.upload_delegate.uploadErrorHandler("video")}}
m.a.mediaComment.upload_delegate={currentType:"audio",submit:function(){var e=m.a.mediaComment.upload_delegate.currentType
var t=m()("#"+e+"_upload")[0].getFiles()
...
m()("#"+e+"_upload")[0].upload()},selectHandler:function(e){m.a.mediaComment.upload_delegate.currentType=e
...
var i=m()("#"+e+"_upload")[0].getFiles()[0]
...
return}m()("#media_upload_submit").click()},singleUploadCompleteHandler:function(e,t){m()("#media_upload_progress").progressbar("option","value",100)},allUploadsCompleteHandler:function(e){m()("#media_upload_progress").progressbar("option","value",100)
m()("#"+e+"_upload")[0].addEntries()},entriesAddedHandler:function(e,t){m()("#media_upload_progress").progressbar("option","value",100)
var i=t[0]
...
m.a.mediaComment.entryAdded(i.entryId,i.entryType,i.title)},progressHandler:function(e,t,i,a){var o=100*t/i
m()("#media_upload_progress").progressbar("option","value",o)},uploadErrorHandler:function(e){var t=m()("#"+e+"_upload")[0].getError()
m()("#media_upload_errors").text(n.t("errors.upload_failed","Upload failed with error:")+" "+t)
m()("#media_upload_progress").hide()},setupErrorHandler:function(){m()("#media_upload_feedback_text").text(n.t("errors.media_comment_installation_broken","Media comment uploading has not been set up properly. Please contact your administrator."))
m()("#media_upload_feedback").css("visibility","visible")
m()("#audio_upload_holder").css("visibility","hidden")
m()("#video_upload_holder").css("visibility","hidden")}}
var _=false
var b=null
m.a.mediaComment.init=function(e,t){Promise.all([i.e(4),i.e(18),i.e(79),i.e(352)]).then((()=>{var a=i("ufgb")
b=b||new Date
e=e||"any"
t=t||{}
var o=m.a.trim(m()("#identity .user_name").text()||"")
o&&(o=o+": "+(new Date).toString("ddd MMM d, yyyy"))
var r=t.defaultTitle||o||n.t("titles.media_contribution","Media Contribution")
var s=function(){var i,o
...
var s=m.a.trim(m()("#identity .user_name").text())+" "+(new Date).toISOString()
...
const n=o();("Chrome"===n.name&&Number(n.version)>=68||"Firefox"===n.name&&Number(n.version)>=61)&&Promise.all([i.e(1),i.e(2),i.e(3),i.e(6),i.e(7),i.e(8),i.e(9),i.e(10),i.e(12),i.e(15),i.e(20),i.e(95),i.e(103),i.e(567)]).then(i.bind(null,"kImW")).then(e=>{let t=e.default
let i
...
else{var u=m()("<div/>").attr("id","media_comment_dialog")
...
m.a.ajaxJSON("/api/v1/services/kaltura_session","POST",{},e=>{u.data("ks",e.ks)
...
var c=function e(){if(u.data("ks")){const e=p(i("SAfv"))
u.html(e())
i("Sv6n")
u.find("#media_record_tabs").tabs({activate:m.a.mediaComment.video_delegate.expectReady})
s()}else u.data("ks-error")?u.html(u.data("ks-error")):setTimeout(e,500)}
c()
...
var e=m()("#audio_upload")[0]&&m()("#audio_upload")[0].getFiles&&m()("#audio_upload")[0].getFiles()
...
//# sourceMappingURL=41-c-fcccce0107.js.map