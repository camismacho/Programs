...
%type <astnode> prog functions function statements statement funcall assignment arguments argument expression declarations vardecl parameters whileloop dowhileloop ifthen ifthenelse relexpr localdecls 

/* Token types - either int or string*/
%token <ival> NUMBER COMMA SEMICOLON LPAREN RPAREN LBRACE RBRACE LBRACKET RBRACKET EQUALS KWINT KWCHAR KWIF KWELSE KWWHILE ADDOP RELOP KWDO
%token <str> ID STRING
