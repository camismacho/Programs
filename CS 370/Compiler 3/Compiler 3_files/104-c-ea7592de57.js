(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[104,598],{"/7Jz":function(e,t,a){"use strict"
a.r(t)
var r=a("9kyW")
var n=a.n(r)
var i=a("IEa/")
...
var B=T(R)
var F=E(function(e,t){Object.defineProperty(t,"__esModule",{value:true})
t.default=a
...
T(I)
var q=E(function(e,t){Object.defineProperty(t,"__esModule",{value:true})
t.default=i
var a=r(I)
...
var X=T(Z)
var Y=E(function(e,t){Object.defineProperty(t,"__esModule",{value:true})
t.default=o
...
var b=o[f]
if(Array.isArray(b))for(var m=0;m<b.length;m++)u.push(Pe(f,b[m],c))
else u.push(Pe(f,b,c))}return u.length?"".concat(e,"{").concat(u.join(""),"}"):""}
var Be=null
var Fe=function(e){if(null==Be){Be=document.querySelector("style[data-aphrodite]")
if(null==Be){var t=document.head||document.getElementsByTagName("head")[0]
Be=document.createElement("style")
Be.type="text/css"
Be.setAttribute("data-aphrodite","")
t.appendChild(Be)}}var a=Be.styleSheet||Be.sheet
if(a.insertRule){var r=a.cssRules.length
e.forEach(function(e){try{a.insertRule(e,r)
r+=1}catch(e){}})}else Be.innerText=(Be.innerText||"")+e.join("")}
...
t instanceof z?t.forEach(function(e,t){n+=Ae(t,[e],a,Ne,false).join("")}):Object.keys(t).forEach(function(e){n+=Ae(e,[t[e]],a,Ne,false).join("")})
n+="}"
We(r,[n])
return r}return t}}
var Ie={}
...
e.length>0&&Fe(e)}
var Ye=function(){return Object.keys(Ie)}
...
return et(e,r,t)},flushToStyleTag:Xe,injectAndGetClassName:et,defaultSelectorHandlers:Oe,reset:Ue,resetInjectedStyle:Ke}}a.d(t,"StyleSheet",function(){return dt})
...
self.Headers=d
self.Request=k
self.Response=x}},"8o96":function(e,t,a){"use strict"
...
R[t]=new M(t,1,!1,e,"http://www.w3.org/1999/xlink",!1)});["xml:base","xml:lang","xml:space"].forEach(function(e){var t=e.replace(B,F)
...
a.sanitizeURL&&(t=""+t)
return e+'="'+I(t)+'"'}return A(e)?e+'="'+I(t)+'"':""}var D=null,W=null,H=null,U=!1,K=!1,V=null,G=0
function Z(){if(null===D)throw i(Error(321))
return D}function X(){if(0<G)throw i(Error(312))
return{memoizedState:null,queue:null,next:null}}function Y(){null===H?null===W?(U=!1,W=H=X()):(U=!0,H=W):null===H.next?(U=!1,H=H.next=X()):(U=!0,H=H.next)
return H}function Q(e,t,a,r){for(;K;)K=!1,G+=1,H=null,a=e(t,r)
W=D=null
G=0
H=V=null
return a}function $(e,t){return"function"===typeof t?t(e):t}function J(e,t,a){D=Z()
H=Y()
if(U){var r=H.queue
t=r.dispatch
...
if(e===D)if(K=!0,e={action:a,next:null},null===V&&(V=new Map),a=V.get(t),void 0===a)V.set(t,e)
...
H.memoizedState=[e,t]
return e},useReducer:J,useRef:function(e){D=Z()
H=Y()
...
_e[t]=_e[e]})})
var de=/([A-Z])/g,ce=/^ms-/,ue=n.Children.toArray,he=y.ReactCurrentDispatcher,fe={listing:!0,pre:!0,textarea:!0},be=/^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,me={},pe={}
...
else if(D={},u=o(n.props,_,c),u=Q(o,n.props,u,_),null==u||null==u.render){e=u
ye(e,o)
...
try{h+=this.render(u,s.context,s.domNamespace)}catch(e){throw e}r.length<=this.suspenseDepth&&r.push("")
r[this.suspenseDepth]+=h}}return r[0]}finally{he.current=a,ae=t}}
...
switch(o){case l:case h:case d:case m:case _:return e=ue(e.props.children),this.stack.push({type:null,domNamespace:a,children:e,childIndex:0,context:t,footer:""}),""
case b:throw i(Error(294))}if("object"===typeof o&&null!==o)switch(o.$$typeof){case f:D={}
...
p=pe[p]=g}h+=f+p+":"
f=c
b=null==m||"boolean"===typeof m||""===m?"":b||"number"!==typeof m||0===m||_e.hasOwnProperty(f)&&_e[f]?(""+m).trim():m+"px"
h+=b
f=";"}}u=h||null}c=null
...
break e
default:b=!0}b?ke.hasOwnProperty(v)||(c=v,c=A(c)&&null!=u?c+'="'+I(u)+'"':""):c=q(v,u)
...
s=o+1
i+=n}return s!==o?i+t.substring(s,o):i}},"gSD+":function(e,t,a){"use strict"
var r=a("rePB")
var n=a("1OyB")
var i=a("vuIU")
var o=a("md7G")
...
var E=(w=Object(k["a"])(),x=Object(m["i"])(y,T),w(j=x(j=(z=S=function(e){Object(_["a"])(t,e)
...
var u=Object(g["a"])(t,this.props,function(){return"reset"===s?"span":s})
var h=b["a"].omitViewProps(Object(v["a"])(this.props,t.propTypes),t)
return d.a.createElement(b["a"],Object.assign({},h,{className:f()((e={},Object(r["a"])(e,T.root,true),Object(r["a"])(e,T[s],true),Object(r["a"])(e,T["color-".concat(o)],o),Object(r["a"])(e,T["border-".concat(n)],"none"!==n),Object(r["a"])(e,T.ellipsis,_),e)),as:u,margin:l,elementRef:c,__dangerouslyIgnoreExperimentalWarnings:true}),i)}}])
t.displayName="Heading"
return t}(l["Component"]),S.propTypes={border:u.a.oneOf(["none","top","bottom"]),children:p,color:u.a.oneOf(["primary","secondary","primary-inverse","secondary-inverse","inherit"]),level:u.a.oneOf(["h1","h2","h3","h4","h5","reset"]),as:u.a.elementType,ellipsis:u.a.bool,margin:m["c"].spacing,elementRef:u.a.func},S.defaultProps={children:null,margin:void 0,elementRef:void 0,border:"none",color:"inherit",level:"h2",ellipsis:false},z))||j)||j)},japM:function(e,t,a){"use strict"
Object.defineProperty(t,"__esModule",{value:true})
...
b=0
l=f=d=h=void 0}function z(){return void 0===h?u:j(n())}function T(){var e=n(),a=w(e)
l=arguments
d=this
f=e
...
return e},{})}function Be(e){let t=Object.keys(e).map(t=>"".concat(t,":").concat(e[t])).join(";")
t&&(t="".concat(t,";"))
return t}function Fe(e){const t=Array.from(e.childNodes)
...
a("x1Tw")
const Ie=/^\S+\.\S+$/
var qe={id:"img-alt-filename",test:e=>!Ie.test(e.getAttribute("alt")),data:e=>{const t=e.getAttribute("alt")
...
return e.querySelector("th")},data:e=>({header:"none"}),form:()=>[{label:fe("Set table header"),dataKey:"header",options:[["none",fe("No headers")],["row",fe("Header row")],["col",fe("Header column")],["both",fe("Header row and column")]]}],update:(e,t)=>{We.call(e.querySelectorAll("th"),e=>{Ae(e,"td")})
...
e.setAttribute("data-mce-style",Be(a))
...
var Xe={id:"large-text-contrast",test:function(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
const a=true==t.disableContrastCheck
const r=!Fe(e)
if(a||r||Me(e)||!J.a.isLargeText(e))return true
return J()(e)},data:Ze.data,form:Ze.form,update:Ze.update,message:()=>fe("Text larger than 18pt (or bold 14pt) should display a minimum contrast ratio of 3:1."),why:()=>fe("Text is difficult to read without sufficient contrast between the text and the background, especially for those with low vision."),link:"https://www.w3.org/TR/WCAG20-TECHS/G17.html",linkText:()=>fe("Learn more about color contrast")}
...
var zt=[Ne,qe,De,He,Ke,Ze,Xe,at,ct,ht,mt,St]
const Tt=()=>{}
...
Ot.push(e)}function Pt(e){const t=fe.setup()
t.locale=e
fe.setup(t)}var Mt=a("DSFK")
var Rt=a("25BE")
var Bt=a("PYwp")
function Ft(e){return Object(Mt["a"])(e)||Object(Rt["a"])(e)||Object(Bt["a"])()}const Nt=()=>{}
...
const a=Array.from(e.dom.doc.styleSheets),r=Ft(a),n=(r[0],r.slice(1))
...
t()}Lt(e=>e.setConfig({beforeCheck:It,afterCheck:qt}))
...
//# sourceMappingURL=104-c-ea7592de57.js.map