(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[44],{"13m+":function(e,t,o){"use strict"
var c=o("17x9")
var l=o.n(c)
var a=o("v0Tn")
const i=l.a.shape,n=l.a.string,r=l.a.arrayOf,_=l.a.oneOf,s=l.a.bool,u=l.a.instanceOf
const k={}
k.migrationState=_(a["a"].statesList)
...
var s=o.n(_)
var u=o("hPGw")
function k(e,t){var o=Object.keys(e)
...
var C=a["default"].scoped("blueprint_coursesLockToggle")
var w=o("Xx/m")
var j=o("5Shj")
var y=o("4Pkj")
var q=o("WfMV")
var E=o("o/ft")
var S=o("kC3k")
const A={ADMIN_LOCKED:{label:C.t("Locked"),icon:E["a"],tooltip:C.t("Unlock"),variant:"primary"},ADMIN_UNLOCKED:{label:C.t("Blueprint"),icon:S["a"],tooltip:C.t("Lock"),variant:"default"},ADMIN_WILLUNLOCK:{label:C.t("Blueprint"),icon:S["a"],tooltip:C.t("Unlock"),variant:"default"},ADMIN_WILLLOCK:{label:C.t("Locked"),icon:E["a"],tooltip:C.t("Lock"),variant:"primary"},TEACH_LOCKED:{label:C.t("Locked"),icon:E["a"]},TEACH_UNLOCKED:{label:C.t("Blueprint"),icon:S["a"]}}
class I extends s["Component"]{static setupRootNode(e,t,o){const c=document.createElement("span")
...
this.onEnter=()=>{this.props.isToggleable&&this.setState({mode:this.props.isLocked?A.ADMIN_WILLUNLOCK:A.ADMIN_WILLLOCK})}
this.onExit=()=>{this.props.isToggleable&&this.setState({mode:this.props.isLocked?A.ADMIN_LOCKED:A.ADMIN_UNLOCKED})}
this.state={}
e.isToggleable?this.state.mode=e.isLocked?A.ADMIN_LOCKED:A.ADMIN_UNLOCKED:this.state.mode=e.isLocked?A.TEACH_LOCKED:A.TEACH_UNLOCKED}render(){const e=this.state.mode.icon
...
const i=this.props.isLocked?C.t("Locked. Click to unlock."):C.t("Unlocked. Click to lock.")
o=Object(c["a"])(j["a"],{tip:a,placement:"top",variant:"inverse",on:["hover","focus"]},void 0,Object(c["a"])(w["a"],{variant:l,onClick:this.props.onClick,onFocus:this.onEnter,onBlur:this.onExit,onMouseEnter:this.onEnter,onMouseLeave:this.onExit,"aria-pressed":this.props.isLocked},void 0,Object(c["a"])(e,{}),Object(c["a"])(y["a"],{},void 0,t),Object(c["a"])(q["a"],{},void 0,i)))}else o=Object(c["a"])("span",{className:"bpc__lock-no__toggle"},void 0,Object(c["a"])("span",{className:"bpc__lock-no__toggle-icon"},void 0,Object(c["a"])(e,{})),Object(c["a"])(v["a"],{size:"small"},void 0,t))
return Object(c["a"])("span",{className:"bpc-lock-toggle"},void 0,o)}}I.defaultProps={isToggleable:false,onClick:()=>{}}
o.d(t,"default",function(){return T})
function B(e,t){var o=Object.keys(e)
if(Object.getOwnPropertySymbols){var c=Object.getOwnPropertySymbols(e)
t&&(c=c.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable}))
o.push.apply(o,c)}return o}function D(e){for(var t=1;t<arguments.length;t++){var o=null!=arguments[t]?arguments[t]:{}
t%2?B(o,true).forEach(function(t){Object(l["a"])(e,t,o[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(o)):B(o).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(o,t))})}return e}class T{constructor(){this.toggleLocked=()=>{const e=this.props.itemType
...
this.render()}getItemLocks(){return D({},this.state.itemLocks)}isMasterContent(){return this.state.isMasterContent}isChildContent(){return this.state.isChildContent}showToggleError(){_.a.flashError(n.t("There was a problem toggling the content lock."))}setupToggle(e){if(!this.props.toggleWrapperSelector)return
...
this.setupToggle(()=>{k.a.render(Object(c["a"])(I,{isLocked:this.state.isLocked,isToggleable:"show"===this.props.page&&this.state.isMasterContent,onClick:this.toggleLocked}),this.toggleNode)})}renderBanner(){this.bannerNode||(this.bannerNode=O.setupRootNode())
k.a.render(Object(c["a"])(O,{isLocked:this.state.isLocked,itemLocks:this.state.itemLocks}),this.bannerNode)}render(){this.renderBanner()
this.renderLockToggle()}}}}])

//# sourceMappingURL=44-c-5e775f9bfa.js.map