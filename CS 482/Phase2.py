...
class App(object):
    def __init__(self, window,ip,user,pswd,db):
        ...
        window.wm_title("Phase 2 Database Interface")
        ...
        '''Query Panel'''
        #Run tag field
        self.runtag_label = Label (window, text= "Query: ")
        ...
        #Start time field
        self.start_t_label = Label (window, text= "Single Insertion: ")
        ...
        #End time field
        self.end_t_label = Label (window, text= "Bulk Loading: ")
        ...
        #Label for Entry box
        self.save_label = Label (window, text= "Table Location: ")
        ...
        self.save_button = Button (window, text="Delete Data")
