...
insert into Players values('Pistol Pete',1001,'Aggies','QB',10,4500,100000);
insert into Players values('John Doe',1002,'Cowboys','RB',30,500,2000);
insert into Players values('Tony Stark',1003,'Dodgers','WR',2,26,30000);
insert into Players values('John Price',1004,'Lakers','QB',0,13,1500000);
insert into Players values('Dr. Phil',1005,'Professionals','RB',10004,567000,65000);
...
insert into Play values(1005, 505);00
